...
save(fnamedotmat, 'lambda2','lambda1','tmax','ODtend_all', 'ODplugged','ODnumplugs', 'ODa_values','ODatests','la','Bo', ...
    'Rc', 'ODRsol_all',"atests_inc", "atests_max", ...
    'atests_min', 'randSeed', '-v7.3');   
